    ...
    <div class="container primary">
      ...
      <div class='item wrapper-2'>
        <div class='grid-container-2'>
            <button class='custom-item custom-1'>Let's Start a Discussion</button>
      ...
      <div class='item main'>
        <div class='grid-container'>
            ...
            <button class='grid-item item-j'>Time Left</button>
            <img class='grid-image item-g' src={process.env.PUBLIC_URL + './machineLearningImage.PNG'}/>
            <h1 class='grid-item item-i'>Time Remaining</h1>

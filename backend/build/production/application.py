...
application.config['heroku_cloudcube_url']='https://cloud-cube-us2.s3.amazonaws.com/o20wmbxb0ykx'

# initialize the database
db=SQLAlchemy(application)

# create a db model
# we can code python we don't need to code SQL
...
CORS(application, resources={r"/profile": {"origins": "https://prod.d2ex35j7wbbaej.amplifyapp.com"}, r"/dbPost": {"origins": "https://prod.d2ex35j7wbbaej.amplifyapp.com"}, r"/signIn": {"origins": "https://prod.d2ex35j7wbbaej.amplifyapp.com"}})
...
@application.route('/db/fitness', methods=['POST'])
...
# Perfect
@application.route('/dbPost', methods=['POST'])
def db_post():
...
@application.route('/ez', methods=['GET', 'POST'])
def hope_it_works():
    posted_data_received=request.json
